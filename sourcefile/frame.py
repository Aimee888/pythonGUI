...
def tabview_set(frame_face):
    tab_view = TabView(frame_face, generate_body=create_body,
                       select_listen=select, remove_listen=remove)
    body = tab_view.body

    label_1 = tk.Label(body, text="this is tab1")
    label_2 = tk.Label(body, text="this is tab2")
